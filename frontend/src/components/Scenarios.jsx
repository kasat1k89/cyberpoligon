...
export default function Scenarios() {
  ...
  const handleDelete = async (id) => {
    ...
    if (!window.confirm(`Удалить сценарий "${script?.Название}"?`)) {
      return;
    }
    ...
    <Card view="outlined" type="container">
      <div className="vm-card">
          ...
          <div className="vm-name">
              ...
              <Text variant="header-1">Сценарии</Text>
              <Text variant="body-2">Все доступные сценарии</Text>
          </div>
          ...
          <div className="vm-params">
            ...
            <MyTable
                ...
                columns={[
                  ...
                  { id: "Сложность сценария", title: "Сложность сценария" },
                  { id: "Сложность расследования", title: "Сложность расследования" },
                  { id: "Сложность атаки", title: "Сложность атаки" },
                ]}
                selectable
